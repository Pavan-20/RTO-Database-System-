...
public class isearch extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(r2);
        r2.setBounds(480, 220, 220, 31);

        r1.setFont(new java.awt.Font("Verdana", 1, 18)); // NOI18N
        r1.setText("INSURANCE ID");
        r1.setOpaque(false);
        ...
        jPanel1.add(r1);
        r1.setBounds(280, 220, 180, 31);
        jPanel1.add(t11);
        t11.setBounds(500, 300, 115, 26);

        jLabel2.setFont(new java.awt.Font("Verdana", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("ENTER THE DATA :");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(300, 300, 190, 30);
        ...
        jButton1.setBounds(500, 340, 113, 31);
        ...
        t1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "INSURANCE ID", "VEHICLE NUMBER", " NAME", "PERIOD", "AMOUNT", "ADDRESS"
            }
        ));
        jScrollPane1.setViewportView(t1);

        jPanel1.add(jScrollPane1);
        jScrollPane1.setBounds(150, 390, 738, 184);
        ...
        jButton2.setBounds(20, 680, 63, 25);
        ...
        jButton3.setBounds(950, 680, 59, 25);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            if(r1.isSelected())
            {
                ResultSet r=s.executeQuery("SELECT * FROM insurance WHERE insurance_id="+t11.getText()+";");
                ...
                while(r.next())
    {
        ...
        t.addRow(new Object[]{insurance_id,vehicle_number,name,insurance_period,amount,address});
            ...
            else if(r2.isSelected())
            {
                ...
                pf=c.prepareStatement("SELECT * FROM insurance WHERE vehicle_number=?");
                pf.setString(1,cq);
               ...
               while(r.next())
    {
       String insurance_id=r.getString(1);
        ...
        t.addRow(new Object[]{insurance_id,vehicle_number,name,insurance_period,amount,address});
            ...
            {          
                String cq=t11.getText();
                pf=c.prepareStatement("SELECT * FROM insurance WHERE name=?");
                pf.setString(1,cq);
                ResultSet r=pf.executeQuery();
...
insurance frame011=new insurance();
isearch.this.setVisible(false);
frame011.setVisible(true);
